"""Regression checks for the parity-tool-scan-flow casebook."""
...
from casebook.harness import assert_expected, parity_tool_scan_flow_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(parity_tool_scan_flow_summary(), assert_expected())
